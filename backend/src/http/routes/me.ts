  ...
  app.delete(
    '/me',
    {
      ...
      schema: {
        ...
        description: [
          'Бесплатно и сразу удаляет профиль, дневник, согласия и состояние бота, отменяет активные брони с возвратом порций в горящие предложения и стирает объяснения показанных предложений.',
