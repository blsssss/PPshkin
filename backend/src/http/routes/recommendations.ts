    ...
    '/recommendations',
    {
      ...
      schema: {
        ...
        description: [
          ...
          'В демо-режиме точка дальше 50 км от Казани заменяется центром Казани, тогда demoCenterUsed равен true: сообщите гостю, что показаны тестовые заведения в центре Казани.',
